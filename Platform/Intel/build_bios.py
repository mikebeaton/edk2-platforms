...
def pre_build(build_config, build_type="DEBUG", silent=False, toolchain=None, skip_tests=False):
...
def get_cmd_arguments(build_config):
    ...
    parser.add_argument('--skip-tests', dest='skip_tests',
                        help='skips tests', action='store_true')
